...
/** Centralized exception handler for REST controllers in the application. */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorInfo> handleNoticeException(NoticeException ex) {
        return new ResponseEntity<>(
                new ErrorInfo("Notice Error", ex.getMessage()), HttpStatus.BAD_REQUEST);
    }
