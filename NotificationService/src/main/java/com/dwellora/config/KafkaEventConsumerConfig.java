...
public class KafkaEventConsumerConfig {
    ...
    public ConsumerFactory<String, EventCreatedEvent> eventConsumerFactory() {
        JsonDeserializer<EventCreatedEvent> deserializer = new JsonDeserializer<>(EventCreatedEvent.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EventCreatedEvent> eventKafkaListenerContainerFactory() {
    ...
    public ConsumerFactory<String, RsvpConfirmedEvent> rsvpConsumerFactory() {
        JsonDeserializer<RsvpConfirmedEvent> deserializer = new JsonDeserializer<>(RsvpConfirmedEvent.class);
        deserializer.setRemoveTypeHeaders(false);
        deserializer.addTrustedPackages("*");
        deserializer.setUseTypeMapperForKey(true);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, RsvpConfirmedEvent> rsvpKafkaListenerContainerFactory() {
    ...
    public ConsumerFactory<String, RsvpCancelledEvent> rsvpCancelledConsumerFactory() {
        JsonDeserializer<RsvpCancelledEvent> deserializer = new JsonDeserializer<>(RsvpCancelledEvent.class);
        deserializer.setRemoveTypeHeaders(false);
        deserializer.addTrustedPackages("*");
        deserializer.setUseTypeMapperForKey(true);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, RsvpCancelledEvent> rsvpCancelledKafkaListenerContainerFactory() {
