...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorInfo> handleNotificationNotFoundException(
            NotificationNotFoundException ex) {
        ErrorInfo errorInfo = new ErrorInfo("Notification Not Found", ex.getMessage());
        return new ResponseEntity<>(errorInfo, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(NotificationException.class)
    public ResponseEntity<ErrorInfo> handleNotificationException(NotificationException ex) {
        ErrorInfo errorInfo = new ErrorInfo("Notification Service Error", ex.getMessage());
        return new ResponseEntity<>(errorInfo, HttpStatus.BAD_REQUEST);
    }
